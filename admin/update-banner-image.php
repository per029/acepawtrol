...
move_uploaded_file($_FILES["image"]["tmp_name"],"images/".$newimage);
 ...
 $eid=$_GET['lid'];
    ...
    $query=mysqli_query($con, "update  tblbanners set banner_image='$newimage' where banner_id='$eid' ");
    if ($query) {
...
?> 
							 ...
							 <div class="form-group"> <label for="exampleInputEmail1">Banners Name</label> <input type="text" class="form-control" id="bname" name="bname" placeholder="Banners Name" value="<?php  echo $row['banner_name'];?>" readonly="true"> </div>
							 
							 <div class="form-group"> <label for="exampleInputPassword1">Old Image</label>  <img src="images/<?php echo $row['banner_image']?>" width="200">
               </div>
