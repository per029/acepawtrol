...
<html>
<head>
<title>Ace Pawtrol || Manage Unread Inquiry</title>
...
<body class="cbp-spmenu-push">
	<div class="main-content">
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="tables">
					<h3 class="title1">View Inquiry</h3>
...
?>
                                 <table class="table table-bordered mg-b-0" style="font-size: 20px;">
                                   ...
                                   <tr style="color: blue;font-size: 30px;text-align: center;" ><td colspan="4">View Inquiry</td></tr>
