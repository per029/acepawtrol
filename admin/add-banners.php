...
move_uploaded_file($_FILES["image"]["tmp_name"],"images/".$newimage);
    ...
    $query=mysqli_query($con, "insert into  tblbanners(banner_name,banner_image) value('$bname','$newimage')");
    if ($query) {
      echo "<script>alert('Banner has been added.');</script>"; 
  ...
  <div class="main-content">
   ...
   <?php include_once('includes/header.php');?>
    ...
    <div id="page-wrapper">
      <div class="main-page">
        <div class="forms">
          <h3 class="title1">Add Banners</h3>
          <div class="form-grids row widget-shadow" data-example-id="basic-forms"> 
            <div class="form-title">
              <h4>Ace Petshop Banners:</h4>
            </div>
            <div class="form-body">
    ...
    echo $msg;
               ...
               <div class="form-group"> <label for="exampleInputEmail1">Banner Name</label> <input type="text" class="form-control" id="bname" name="bname" placeholder="Service Name" value="" required="true"> </div>
