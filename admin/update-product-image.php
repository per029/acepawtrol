...
move_uploaded_file($_FILES["image"]["tmp_name"],"images/".$newimage);
 ...
 $eid=$_GET['lid'];
    ...
    $query=mysqli_query($con, "update  tblproduct set product_image='$newimage' where product_id='$eid' ");
    if ($query) {
...
?> 
							 ...
							 <div class="form-group"> <label for="exampleInputEmail1">Product Name</label> <input type="text" class="form-control" id="proname" name="proname" placeholder="Product Name" value="<?php  echo $row['product_name'];?>" readonly="true"> </div>
							 
							 <div class="form-group"> <label for="exampleInputPassword1">Old Image</label>  <img src="images/<?php echo $row['product_image']?>" width="200">
               </div>
