...
<div class="col-md-4 widget states-last">
						<?php $query6=mysqli_query($con,"Select * from tblproduct");
$totalpro=mysqli_num_rows($query6);
?>
						<div class="stats-left">
							<h5>Total</h5>
							<h4>Product</h4>
	...
	<div class="row calender widget-shadow">
					<div class="row-one">
					<div class="col-md-4 widget">
						<?php $query7=mysqli_query($con,"Select * from tblbrand where brand_active='1'");
$totalbrand=mysqli_num_rows($query7);
?>
						<div class="stats-left ">
							<h5>Total</h5>
							<h4>Brands</h4>
					...
					<div class="col-md-4 widget states-mdl">
						<?php $query8=mysqli_query($con,"Select * from  tblcategory where category_active='1'");
$totalcat=mysqli_num_rows($query8);
?>
						<div class="stats-left">
							<h5>Total</h5>
							<h4>Categories</h4>
