...
if ($result->num_rows > 0) {
	...
	while($row = $result->fetch_array()) {
		...
		$button = '<td>
					    ...
					    <a type="button" data-toggle="modal" data-target="#editProductModal" onclick="editProduct('.$productId.')"><i class ="btn btn-primary">Edit</i></a>
					    <a type="button" data-toggle="modal" data-target="#removeProductModal" onclick="removeProduct('.$productId.')"> <i class ="btn btn-danger">Delete</i></a></td>';
