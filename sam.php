    ...
    switch (mainCategory.value) {
      case "Category A":
        subCategory.innerHTML = `
          ...
          <label><input type="checkbox" name="size[]" value="SMALL"> SMALL ₱ 199.00</label><br>
          <label><input type="checkbox" name="size[]" value="MEDIUM"> MEDIUM ₱ 249.00</label><br>
          <label><input type="checkbox" name="size[]" value="LARGE"> LARGE ₱ 300.00</label><br>
          <label><input type="checkbox" name="size[]" value="EXTRA LARGE"> EXTRA LARGE ₱ 350.00</label><br>
        `;
        break;
      case "Category B":
        subCategory.innerHTML = `
          <h3>Select Full Groom Dog Size</h3>
          <label><input type="checkbox" name="size[]" value="SMALL"> SMALL ₱ 300.00</label><br>
          <label><input type="checkbox" name="size[]" value="MEDIUM"> MEDIUM ₱ 350.00</label><br>
          <label><input type="checkbox" name="size[]" value="LARGE"> LARGE ₱ 450.00</label><br>
          <label><input type="checkbox" name="size[]" value="EXTRA LARGE"> EXTRA LARGE ₱ 550.00</label><br>
          <label><input type="checkbox" name="size[]" value="DOUBLE EXTRA LARGE"> DOUBLE EXTRA LARGE ₱ 650.00</label><br>
        `;
        break;
      case "Category C":
        subCategory.innerHTML = `
