<div class=" sidebar" role="navigation">
        ...
        <nav class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
          <ul class="nav" id="side-menu">
            ...
            <li>
              <a href="add-services.php"><i class="fa fa-picture-o nav_icon"></i>Banners<span class="fa arrow"></span> </a>
              <ul class="nav nav-second-level collapse">
                <li>
    ...
    <li>
            ...
            <li>
              ...
              <li>
              <a href="#"><i class="fa fa-check-square-o nav_icon"></i>Inventory<span class="fa arrow"></span></a>
              <ul class="nav nav-second-level collapse">
