...
if(isset($_POST["verify"])){
    ...
    if($otp != $otp_code){
       ...
       <?php
        ...
        mysqli_query($con, "UPDATE tbluser SET status = 1 WHERE Email = '$email'");
        ?>
         <script>
...
?>
               ...
               <?php } ?> </div>
                <div class="map-content-9 mt-lg-0 mt-4">
                    <form method="post">
                        <div>
                            <input type="text" class="form-control" id="otp" name="otp_code" required="true" placeholder="Enter OTP Code Here" required="true">
...
var x = setInterval(function() {
  ...
  if (distance < 0) {
    ...
    document.getElementById("countdown").innerHTML = "Expired";
                        ...
                        <button type="submit" class="btn btn-contact" Value="Verify" name="verify">Submit</button>
                    </form>
                </div>
    </div>
